...
### Car Performance and Usage Metrics[^1][^1]
...
A hybrid vehicle combines an internal combustion engine and an electric
motor. It therefore uses both fuel (gasoline, diesel, biofuel) and
electricity. In such a vehicle, the lithium battery included in the
vehicle is smaller than in a 100% battery-electric vehicle.

## ES Model Parameters

All the parameters concerning the Car PHEV are listed in the table
below.

```python exec="on"
from bibdatamanagement import *

print(MdDisplay.print_md_params(bib_file_path='docs/assets/ES_Canada_3.bib', filter_entry='CAR_PHEV'))
```
...
print(MdDisplay.print_md_sources(bib_file_path='docs/assets/ES_Canada_3.bib', filter_entry='CAR_PHEV'))
```
